...
/* harmony import */ var styles_style_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1733);
...
/* harmony import */ var firebase_app__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3745);
/* harmony import */ var firebase_analytics__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9500);
...
const App = ({ Component , pageProps  })=>{
    ...
    const sf = _config_theme_json__WEBPACK_IMPORTED_MODULE_2__/* .fonts.font_family.secondary */ .R.k.secondary;
    ...
    const tagManagerArgs = {
        gtmId: _config_config_json__WEBPACK_IMPORTED_MODULE_1__/* .params.tag_manager_id */ .f.tag_manager_id
    };
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        setTimeout(()=>{
             true && _config_config_json__WEBPACK_IMPORTED_MODULE_1__/* .params.tag_manager_id */ .f.tag_manager_id && react_gtm_module__WEBPACK_IMPORTED_MODULE_5___default().initialize(tagManagerArgs);
        }, 5000);
...
"use strict";
module.exports = JSON.parse('{"R":{"k":{"T":"Questrial:wght@400;500;600;700"}}}');
